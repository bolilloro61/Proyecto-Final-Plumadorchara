...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textPzs = QPlainTextEdit(self.frame_4)
        self.textPzs.setObjectName(u"textPzs")

        self.verticalLayout_2.addWidget(self.textPzs)
        ...
        self.textLoteDate = QDateEdit(self.frame_4)
        self.textLoteDate.setObjectName(u"textLoteDate")

        self.verticalLayout_2.addWidget(self.textLoteDate)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"Piezas por lote", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Fecha de creacion", None))
