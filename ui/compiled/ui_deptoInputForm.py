...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textGerente = QPlainTextEdit(self.frame_4)
        self.textGerente.setObjectName(u"textGerente")

        self.verticalLayout_2.addWidget(self.textGerente)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"Gerente", None))
