...
class Ui_providerAdd(object):
    ...
    def retranslateUi(self, providerAdd):
        ...
        self.label.setText(QCoreApplication.translate("providerAdd", u"Id", None))
        self.label_2.setText(QCoreApplication.translate("providerAdd", u"Nombre", None))
        self.label_3.setText(QCoreApplication.translate("providerAdd", u"Material", None))
        self.label_4.setText(QCoreApplication.translate("providerAdd", u"Telefono", None))
        self.label_5.setText(QCoreApplication.translate("providerAdd", u"Email", None))
